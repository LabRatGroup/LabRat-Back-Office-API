...
class MlModelPredictionControllerTest extends TestCase
{
    ...
    public function project_user_should_create_model_prediction()
    {
        ...
        // When
        $response = $this->postJson(route('prediction.create'), $data, $this->getAuthHeader($user));
    ...
    public function non_project_user_should_not_create_model_prediction()
    {
        ...
        // When
        $response = $this->postJson(route('prediction.create'), $data, $this->getAuthHeader($nonMember));
    ...
    public function project_user_should_access_model_prediction()
    {
        ...
        // When
        $response = $this->get(route('prediction.show', ['id' => $prediction->id]), $this->getAuthHeader($user));
    ...
    public function team_member_should_access_model_prediction()
    {
        ...
        // When
        $response = $this->get(route('prediction.show', ['id' => $prediction->id]), $this->getAuthHeader($member));
