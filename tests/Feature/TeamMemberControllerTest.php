...
class TeamMemberControllerTest extends TestCase
{
    ...
    public function should_add_member_as_owner()
    {
        ...
        // When
        $response = $this->postJson(route('team.updateMember'), $data, $this->getAuthHeader($owner));
    ...
    public function non_owner_should_not_add_member_as_owner()
    {
        ...
        // When
        $this->be($member);
        $response = $this->postJson(route('team.updateMember'), $data, $this->getAuthHeader($member));
    ...
    public function should_remove_member_from_team()
    {
        ...
        // When
        $response = $this->postJson(route('team.deleteMember'), $data, $this->getAuthHeader($owner));
    ...
    public function should_remove_itself_from_team()
    {
        ...
        // When
        $this->be($member);
        $response = $this->postJson(route('team.deleteMember'), $data, $this->getAuthHeader($member));
